...
class LatentDiffusion(DDPM):
    ...
    def log_images(self, batch, N=8, n_row=4, sample=True, ddim_steps=50, ddim_eta=0., return_keys=None,
                   ...
                   use_ema_scope=True,
                   **kwargs):
        ema_scope = self.ema_scope if use_ema_scope else None
...
class LatentInpaintDiffusion_control(LatentFinetuneDiffusion):
    # NOTE(wjh): The original LatentInpaintDiffusion in ControlNet source code
    """
